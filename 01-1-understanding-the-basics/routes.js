...
// Create request handler to use as a callback by server
...
// Export request handler from this file making it findable with require in others
// If you need to export more than one thing from a file you can export an object with key value pairs representing each thing.
// Example `module.exports = { handler: requestHandler, someText: "hard coded text value" }
